	...
	<div class="wrapper">
		...
		<form action="" method="POST" enctype="multipart/form-data">
			<table class="tbl-30">
				<tr>
					<td>Title: </td>
					<td>
						<input type="text" name="title" placeholder="Category title" class="input-box">
					</td>
				</tr>
		...
		<?php 
		   ...
		   if(isset($_POST['submit'])) 
		   {
		   	...
		   	//for radio input, we need to check whether the butto is clicked or not
		   	...
		   	{
		   		//upload the image
		   		//to upload image name and source path and destination path
